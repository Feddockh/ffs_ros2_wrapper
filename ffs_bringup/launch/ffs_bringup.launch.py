...
def generate_launch_description():
    return LaunchDescription([
        LaunchArg(
            'calib_dir',
            default_value=PJoin([FindPackageShare('ffs_bringup'), 'calibs']),
            description='Directory containing camera calibration YAML files',
        ),
        LaunchArg(
            'spinnaker_config_file',
            default_value=PJoin([FindPackageShare('ffs_bringup'), 'configs', 'firefly.yaml']),
            description='Path to the Spinnaker camera configuration YAML file.',
        ),
        LaunchArg(
            'spinnaker_param_file',
            default_value=PJoin([FindPackageShare('ffs_bringup'), 'params', 'firefly.yaml']),
